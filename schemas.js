...
const bbcNews = [
    { select: "head > title", name: "title", transform: extractor.helpers.getTextContent },
    {
                ...
                children: [
                    {
                        ...
                        name: "heading",
                        transform: extractor.helpers.getTextContentNormalised,
                    },
                    {
                    ...
                    },
                    {
                        ...
                        transform: (el) => {
                            ...
                            var location = extractor.helpers.getTextContentNormalised(el.querySelector("li.nw-c-promo-meta a"));
